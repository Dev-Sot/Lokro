...
const ROLES = [
  {
    ...
    desc: 'Encuentra y contrata profesionales',
    icon: User,
  },
  {
    value: 'PROVIDER' as const,
    label: 'Ofrezco servicios',
    desc: 'Ofrece tus habilidades y gana dinero',
    icon: Wrench,
  },
]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Gratis para siempre en el plan básico</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <Label>¿Qué vas a hacer en Lokro?</Label>
          <div className="grid grid-cols-2 gap-3">
            {ROLES.map(({ value, label, desc, icon: Icon }) => (
              ...
              >
                <Icon
                  size={18}
                  className={selectedRole === value ? 'text-primary' : 'text-muted-foreground'}
                />
        ...
        <div className="space-y-1.5">
          ...
          <Input id="name" placeholder="Juan García" autoComplete="name" {...register('name')} />

          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-3">
                <svg viewBox="0 0 100 125" fill="none" className="h-8 w-[26px]" aria-hidden="true">
                  <path d="M50 5C27.4 5 9 23.4 9 46C9 68.6 50 120 50 120C50 120 91 68.6 91 46C91 23.4 72.6 5 50 5Z" fill="#2563EB"/>
                  <circle cx="50" cy="37" r="16" fill="white"/>
                  <path d="M17 67C17 51 31 44 50 44C69 44 83 51 83 67Z" fill="white"/>
                </svg>
                <span className="text-2xl font-bold tracking-tight leading-none text-blue-400">Lokro</span>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <a href="#" aria-label="X" className="hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.631 5.905-5.631zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                {/* LinkedIn */}
